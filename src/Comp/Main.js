    ...
    return (
        <div className='entire-page' style={{ display: 'flex', margin: '10px 0px', gap: '40px' }}>
            <div className='sidebar' style={{ width: '150px' }}>
                <button style={{ padding: '5px 25px' ,backgroundColor:"#007BFF",color:"white",outline:"none",border:"none",padding:"8px",borderRadius:"4px"}} onClick={() => { setData(prevValue => [...prevValue, abc()]) }}>ADD Notes +</button>
                <hr />
                <div>
                    {data.map((markdown, index) => (
                        ...
                        >
                            ...
                            <button
                                ...
                                style={{ position: 'absolute', right: '5px', top: '5px', zIndex: '1', backgroundColor: 'black',padding:"4px" ,border: 'none', color: 'white' ,textAlign:"center"}}
                            >
                                <ImCross/>
                            </button>
                        </div>
    ...
    return (
        <div>
            <div className="all-btns" style={{display:'flex', gap:'50px'}}>
                <button style={{backgroundColor:"#007BFF",color:"white",outline:"none",border:"none",padding:"8px",borderRadius:"4px"}} onClick={() => setShowPreview(prev => !prev)}>
